...
import com.github.wcquan.library.widget.CircularLoading;
...
public abstract class RootFragment<T extends BasePresenter> extends BaseFragment<T> {
    ...
    private CircularLoading ivLoading;
    ...
    protected void initEventAndData() {
        ...
        ivLoading = (CircularLoading) viewLoading.findViewById(R.id.iv_progress);
